...
public class Encryption {
    ...
    public String EcryptPassword(String password) throws NoSuchAlgorithmException, InvalidKeySpecException {
        String originalPassword = password;
        String generatedSecuredPasswordHash = generateStorngPasswordHash(originalPassword);
        return generatedSecuredPasswordHash;
    }

    public boolean Validate(String password,String generatedSecuredPasswordHash) throws NoSuchAlgorithmException, InvalidKeySpecException {
        //String originalPassword = password;
        //String generatedSecuredPasswordHash = generateStorngPasswordHash(originalPassword);
    ...
    private boolean validatePassword(String originalPassword, String storedPassword) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        for (int i = 0; i < hash.length && i < testHash.length; i++) {
            diff |= hash[i] ^ testHash[i];//diff=diff|(hash[i] ^ testHash[i])
        }
        return diff == 0;
    }
